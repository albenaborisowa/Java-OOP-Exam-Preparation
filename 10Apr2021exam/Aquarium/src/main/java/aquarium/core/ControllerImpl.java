...
public class ControllerImpl implements Controller {
    ...
    public String calculateValue(String aquariumName) {
        ...
        double fishValue = aquarium.getFish()
                .stream()
                .mapToDouble(Fish::getPrice)
                .sum();

        double decorationsValue = aquarium.getDecorations()
                .stream()
                .mapToDouble(Decoration::getPrice)
                .sum();

        return String.format(VALUE_AQUARIUM, aquariumName, fishValue + decorationsValue);
    }
